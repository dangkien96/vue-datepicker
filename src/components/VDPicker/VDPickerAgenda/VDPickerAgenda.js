...
const baseMixins = mixins(colorable, Overlayable, Localable);
...
export default baseMixins.extend({
  ...
  computed: {
    ...
    isRangeSelected() {
      ...
      return (
        typeof this.mutableDate === "object" &&
  ...
  methods: {
    ...
    emitSelectedDate(date) {
      ...
      if (this.range) {
        this.pickerDate = new PickerDate(
          date.end.month(),
          date.end.year(),
          this.currentLocale
        );
    ...
    updateSelectedYearMonth(value, mode) {
      const { year, month } = generateMonthAndYear(
        value,
        this.pickerDate,
        mode
      );
    ...
    genMonths() {
      ...
      return this.$createElement(VDPickerMonths, {
        props: {
          ...
          allowedDates:
            this.type === DATEPICKER_MODES.month
              ? this.allowedDates
              : undefined,
          color: this.color,
          locale: this.currentLocale,
    ...
    genQuarters() {
      ...
      return this.$createElement(VDPickerQuarters, {
        props: {
          ...
          allowedDates:
            this.type === DATEPICKER_MODES.quarter
              ? this.allowedDates
              : undefined,
          color: this.color,
          locale: this.currentLocale,
    ...
    genYears() {
      ...
      return this.$createElement(VDPickerYears, {
        props: {
          ...
          allowedDates:
            this.type === DATEPICKER_MODES.year ? this.allowedDates : undefined,
          color: this.color,
          max: maxYear,
          min: minYear,
          mutableDate: this.mutableDate,
